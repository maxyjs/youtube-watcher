const getInstanceBrowser = require('../../userHandlers/getInstanceBrowser')
...
async function updateCookiesForUser(user) {
  ...
  if (instanceBrowser.error === true) {
    ...
    console.log('\x1b[44m%s\x1b[0m', `Cookie file for user ${user.userName} succesfully updated`) // bg blue
  }
